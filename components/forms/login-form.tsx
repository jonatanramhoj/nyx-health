    ...
    <div className="max-w-sm m-auto w-full">
      <WidgetContainer label="" className="min-h-0!">
        <div className="flex flex-col items-center justify-center py-8">
          <LogoAnimated />
          <h1 className="block mb-4 text-white text-3xl tracking-[8px]">NYX</h1>
          <span className="block mb-4 text-gray-400 text-xs mb-8">
            Know thyself.
          </span>

          <form action={handleSignIn} className="w-full">
            <button
              className="filter-btn w-full flex items-center justify-center text-white text-center"
              type="submit"
            >
              <svg
                width="18"
